...
export class PropertyDetailsClass {
  async getContactDetails(contactId: number) {
    ...
    const response = await apiClient(`${API_BASE_ENDPOINT}/kc-mgr-contact-details/api/v1/${id}`, {
      method: 'GET',
      headers: {
  ...
  async getPropertyDetailsByAddress(address: string, adressObject?: any) {
    ...
    const response = await apiClient(`${API_BASE_ENDPOINT}/kc-proxy-get-property-details/api/v1/search`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async updatePropertyDetails(details: any) {
    ...
    const response = await apiClient(`${API_BASE_ENDPOINT}/kc-mgr-contact/api/v1`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async createQuotes(details: any) {
    ...
    } = await apiClient(`${API_BASE_ENDPOINT}/kc-svc-quotes-make-quote-request/api/v1/create_quote`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  getQuotes = async (): Promise<any> => {
    ...
    const {
      ...
      `${API_BASE_ENDPOINT}/kc-svc-quotes-make-quote-request/api/v1/?quote_request_id=${quote_request_id}&session_id=${session_id}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  async updateQuote(quoteId: string, details: any) {
    ...
    const {response, rate_id} = await apiClient(`${API_BASE_ENDPOINT}/kc-svc-quotes-make-quote-request/api/v1/update`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
